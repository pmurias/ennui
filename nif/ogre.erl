-module(ogre).
-export([init_ogre/0,init_ogre/0,destroy_ogre/0,render_frame/0,key_down/1,capture_input/0,create_scenenode/0,create_entity/2,set_node_position/4,set_node_orientation/5,play/0]).
...
play() ->
    ...
    set_node_position(Node, 0.0, 0.0, 9.0),
    play_loop(),
    destroy_ogre().
play_loop () ->
    capture_input(),
